...
def implement(args):
    ...
    for img_path in image_paths:
        ...
        inputs = dict()
        inputs['images'] = utils.preprocess_image(img_bgr,do_transpose=False)
    ...
    for i,p in enumerate(pred):
        ...
        annotated = utils.draw_detections(original_images[i], boxes_orig, scores, class_ids, utils.COCO_CLASSES)
...
def run_main():
    ...
    ap.add_argument('-m',  '--model_name',      type=str, default='yolov8x-p2_opt_4o', help='quantized model name')
    ...
    ap.add_argument('-hn', '--hostname',        type=str, default='192.168.1.21', help='Target device IP address. Default is 192.168.1.21')
